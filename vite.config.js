        ...
        rollupOptions: {
            output: {
                ...
                manualChunks: function (id) {
                    ...
                    if (/node_modules[\\/](three|three-stdlib|@react-three|maath|camera-controls|detect-gpu|@use-gesture|suspend-react|its-fine|troika-three-text|@monogrid|meshline)[\\/]/.test(id))
                        return 'three-vendor';
